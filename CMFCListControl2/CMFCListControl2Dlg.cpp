...
// CMFCListControl2Dlg.cpp : implementation file
//
...
CCMFCListControl2Dlg::CCMFCListControl2Dlg(CWnd* pParent /*=nullptr*/)
	: CDialogEx(IDD_CMFCLISTCONTROL2_DIALOG, pParent)
{
	m_hIcon = AfxGetApp()->LoadIcon(IDR_MAINFRAME);
}

void CCMFCListControl2Dlg::DoDataExchange(CDataExchange* pDX)
{
	CDialogEx::DoDataExchange(pDX);
	DDX_Control(pDX, IDC_SCORE_LIST, m_score_list);
}

BEGIN_MESSAGE_MAP(CCMFCListControl2Dlg, CDialogEx)
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_BN_CLICKED(IDOK, &CCMFCListControl2Dlg::OnBnClickedOk)
	ON_BN_CLICKED(IDCANCEL, &CCMFCListControl2Dlg::OnBnClickedCancel)
	ON_WM_DESTROY()
END_MESSAGE_MAP()


// CCMFCListControl2Dlg message handlers

BOOL CCMFCListControl2Dlg::OnInitDialog()
{
	...
	m_score_list.SendMessage(LVM_SETEXTENDEDLISTVIEWSTYLE, 0, LVS_EX_FULLROWSELECT | LVS_EX_GRIDLINES);			// 행기준선택 및 그리드 속성 추가
...
void CCMFCListControl2Dlg::OnPaint()
{
	if (IsIconic())
	{
...
HCURSOR CCMFCListControl2Dlg::OnQueryDragIcon()
{
...
void CCMFCListControl2Dlg::OnBnClickedOk()
{
...
void CCMFCListControl2Dlg::OnBnClickedCancel()
{
	// TODO: Add your control notification handler code here
	CDialogEx::OnCancel();
}
...
void CCMFCListControl2Dlg::OnDestroy()
{
	CDialogEx::OnDestroy();
