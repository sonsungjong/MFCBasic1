...
public:
	...
	{
		//mh_font = CreateFont(16, 0, 0, 0, FW_NORMAL, FALSE, FALSE, 0, DEFAULT_CHARSET, OUT_DEFAULT_PRECIS, CLIP_DEFAULT_PRECIS, DEFAULT_QUALITY, DEFAULT_PITCH | FF_SWISS, _T("맑은 고딕"));
		if (nColumn == 6)
		{
			// 1~5등과 31~35등은 글꼴 변경
			int rank = _wtoi(GetItemText(nRow, nColumn));
...
// CCMFCListControl2Dlg dialog
class CCMFCListControl2Dlg : public CDialogEx
{
// Construction
public:
	CCMFCListControl2Dlg(CWnd* pParent = nullptr);	// standard constructor

// Dialog Data
#ifdef AFX_DESIGN_TIME
	enum { IDD = IDD_CMFCLISTCONTROL2_DIALOG };
#endif
